...
if __name__ == '__main__':
    ...
    #     model_dict[(context_direction, context_size)] = (model, tokenizer)
    ...
    for idx, convo in (pbar := tqdm(enumerate(convos))):
        ...
        for (context_direction, context_size), model_dir in models.items():
            # model, tokenizer = model_dict[(context_direction, context_size)]
            ...
            model_surprisals = main(
                # model, tokenizer, 
                texts, model_dir, context_size, context_direction)
